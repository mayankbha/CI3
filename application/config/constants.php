...
define('LOADER_IMG',URL_FRONT_IMAGES.'loader.gif');
...
define('URL_ADMIN_BUYER_BOOKINGS', SITEURL2.DS.'admin'.DS.'buyer-bookings');
define('URL_ADMIN_INST_BATCHES', SITEURL2.DS.'admin'.DS.'inst-batches');
define('URL_ADMIN_INST_BATCH_ENROLLED_BUYERS', SITEURL2.DS.'admin'.DS.'inst-batche-enrolled-buyers');
define('URL_ADMIN_VIEW_CERTIFICATES', SITEURL2.DS.'admin'.DS.'view-certificates');
define('URL_ADMIN_VIEW_INST_SELLERS', SITEURL2.DS.'admin'.DS.'view-inst-sellers');


define('URL_ADMIN_SELLER_MONEY_CONVERSION_REQUESTS', SITEURL2.DS.'admin'.DS.'seller-money-conversion-requests');
...
define('URL_CATEGORIES_BOOKS', SITEURL2."/categories/books");
...
define('URL_INSTITUTE_OFFERED_BOOKS', SITEURL2."/institute/books");
...
define('URL_INSTITUTE_ENROLLED_BUYERS', SITEURL2."/institute/enrolled_buyers");
...
define('URL_SELLER_INDEX', SITEURL2."/seller/index");
define('URL_SELLER_MANAGE_SUBJECTS', SITEURL2."/seller/manage-subjects");
define('URL_SELLER_MANAGE_LOCATIONS', SITEURL2."/seller/manage-locations");
define('URL_SELLER_LIST_PACKAGES', SITEURL2."/seller/list-packages");
define('URL_SELLER_SUBSCRIPTIONS', SITEURL2."/seller/mysubscriptions");
define('URL_SELLER_VIEW_STUDETNS', SITEURL2."/seller/view_buyers");
define('URL_SELLER_PROFILE_INFO', SITEURL2."/seller/profile-information");
define('URL_SELLER_CREDITS_TRANSACTION_HISTORY', SITEURL2."/seller/credits-transactions-history");
define('URL_SELLER_SELL_BOOKS_ONLINE', SITEURL2."/seller/sell-books-online");
define('URL_SELLER_LIST_SELLING_BOOKS', SITEURL2."/seller/list-selling-books");
define('URL_SELLER_VIEW_SELLING_BOOK_CURRICULUM', SITEURL2."/seller/view-selling-book-curriculum");
define('URL_SELLER_DELETE_BOOK_CURRICULUM_RECORD', SITEURL2."/seller/delete-book-curriculum-record");
define('URL_SELLER_ADMIN_MONEY_REQUEST', SITEURL2."/seller/admin-money-request");


//STUDEN MODULE CONSTANTS

define('URL_BUYER_INDEX', SITEURL2."/buyer/index");
define('URL_OPTIONS_INDEX', SITEURL2."/options/index");
define('URL_BUYER_LIST_PACKAGES', SITEURL2."/buyer/list-packages");
define('URL_BUYER_SUBSCRIPTIONS', SITEURL2."/buyer/mysubscriptions");
define('URL_BUYER_MANAGE_LOCATIONS', SITEURL2."/buyer/manage-locations");
define('URL_BUYER_PREFFERED_TEACHING_TYPES', SITEURL2."/buyer/manage-teaching-types");
define('URL_BUYER_CERTIFICATES', SITEURL2."/buyer/certificates");
define('URL_BUYER_MANAGE_PRIVACY', SITEURL2."/buyer/manage-privacy");
define('URL_BUYER_PERSONAL_INFO', SITEURL2."/buyer/personal-info");
define('URL_BUYER_PROFILE_INFO', SITEURL2."/buyer/profile-information");
define('URL_BUYER_EDUCATION', SITEURL2."/buyer/education");
define('URL_BUYER_CONTACT_INFO', SITEURL2."/buyer/contact-information");
define('URL_BUYER_MY_GALLARY', SITEURL2."/buyer/my-gallery");
define('URL_BUYER_LEADS', SITEURL2."/buyer/buyer_leads");
define('URL_BUYER_REQUIREMENTS', SITEURL2."/buyer/post-requirement");
define('URL_BUYER_MANAGE_BOOKS', SITEURL2."/buyer/manage-books");
define('URL_BUYER_ENROLLED_BOOKS', SITEURL2."/buyer/enrolled-books");
define('URL_BUYER_CREDITS_TRANSACTION_HISTORY', SITEURL2."/buyer/credits-transactions-history");
define('URL_BUYER_MANUAL', SITEURL2.'/buyer/manual_payment_status');

// Home Module
define('URL_VIEW_BUYER_PROFILE', SITEURL2."/home/buyer-profile");
...
define('CREDITS_PAYMENT', 52);


include_once('constants-sellers.php');