<html>
  <head>
    <title>Book Completion Certificate</title>
	...
	<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 col-xs-12" style="border-radius:5px;margin-top:50px;border:5px solid #e6e7ea;padding: 30px 70px;background-size:cover;position:relative;">
	 <div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
	   ...
	   <h3 class="text-center"><?php echo get_languageword('Sellers'); ?></h3>
	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
	   <h4 class="text-center">Have Completed a book entitled <?php if(!empty($booking_det->book_name)) echo '"'.$booking_det->book_name.'"'; ?> <?php echo get_languageword('at Sellers'); ?></h4>
	  </div>
	  ...
	  <div class="row">
	   <div class="col-md-4 col-sm-4 col-xs-4">
	    <h4 class="text-left"><?php echo get_languageword('Signature'); ?>: <?php if(!empty($seller_rec->signature)) echo $seller_rec->signature; ?></h4>
	   </div>
	   ...
	   <div class="col-md-4 col-sm-4 col-xs-4 clearfix">
	     <img src="<?php echo URL_PUBLIC_UPLOADS_SETTINGS;?>setting_35.png" alt="seller" class="img-responsive pull-right" style="background:#736969;">
	   </div>
	  </div>
	 </div>
	 </div>
