...
class Ion_auth
{
	...
	*/
	...
	{
		$this->ion_auth_model->trigger_events('seller_group');
		$general_group = $this->config->item('seller_group', 'ion_auth');
	 ...
	 * @author Adi
	 **/
	public function is_buyer($id=false)
	{
	 ...
	 * @author Ben Edmunds
	 **/
	public function is_member($id=false) //is_buyer also same
	{
