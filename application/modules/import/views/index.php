...
<div class="dashboard-panel">
	...
	if( $type == 'books' ) {
		?>
		Click <a href="<?php echo base_url();?>assets/uploads/import_templates/books.csv">here</a> to download template 
		<?php
	}
	?>
	<?php
		...
		<div class="row">		
			...
			<div class="col-sm-6 ">
				...
				<?php if ($type == "users") { ?>
					...
					<h4>User Group</h4> <small>Please mention group in excel file, default it consider as buyer group 2</small>
					<ul class="list-group">
