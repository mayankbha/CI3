...
<div class="dashboard-panel">
	...
	if(!empty($param2))
		$str .= '/'.$param2;
	echo form_open_multipart('buyer/education'.$str,$attributes);?>
		
		<h4 class="dash-head"><?php echo get_languageword('Education')?>:</h4>
		<div class="education add-more"><a class="btn-add" href="<?php echo base_url();?>buyer/education/add"><i class="fa  fa-plus"></i> &nbsp;<?php echo get_languageword('Add More');?></a></div>
		...
		<div class="delete"><a class="btn-delete" href="<?php echo base_url();?>buyer/education/delete/<?php echo $education->record_id?>" onclick="return confirm('<?php echo get_languageword('are you sure?');?>')"><i class="fa  fa-minus"></i> &nbsp;<?php echo get_languageword('delete');?></a> &nbsp; <a class="btn-edit" href="<?php echo base_url();?>buyer/education/edit/<?php echo $education->record_id?>"><i class="fa  fa-edit"></i> &nbsp;<?php echo get_languageword('edit');?></a></div>
			<?php }} ?>
