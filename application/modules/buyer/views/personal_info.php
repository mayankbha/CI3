...
<div class="dashboard-panel">
	...
	<div class="row">
		...
		echo form_open_multipart('buyer/personal_info',$attributes);?>
			<div class="col-sm-6 ">
			...
			<div class="col-sm-6 ">
				<div class="input-group ">
					<label><?php echo get_languageword('Skype Profile');?>:</label>
					<?php			   
					$val = '';
					if( isset($_POST['submitbutt']) )
					{
						$val = $this->input->post( 'skype' );
					}
					elseif( isset($profile->linkedin) && !isset($_POST['submitbutt']))
					{
						$val = $profile->skype;
					...
					$element = array(
						...
						'value'	=>	$val,
						'class' => 'form-control',
						'placeholder' => get_languageword('Skype'),
					);			
					echo form_input($element);
					?>
				</div>
