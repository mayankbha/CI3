...
<div class="dashboard-panel">
	...
	<div class="row">
		...
		echo form_open_multipart('buyer/post_requirement',$attributes);?>
			<div class="col-sm-6 ">
			...
			<div class="col-sm-6 ">
				<div class="input-group ">
						<label><?php echo get_languageword('Book Seeking');?> <sup>*</sup>:</label>
						<div class="dark-picker dark-picker-bright">
							<?php			   
							
							echo form_dropdown('book_id', $book_opts, '', 'class="select-picker"');
							?>
			...
			<div class="col-sm-6 ">
				<div class="input-group ">
					...
					$element = array(
						...
						//'required' => 'required',
						'class' => 'form-control',
						'placeholder' => get_languageword('present_status_ex:buyer or employee'),
						'description'=>'Now you are ex: buyer or employee or etc'
					);			
			...
			<div class="col-sm-6 ">
				<div class="input-group ">
					<label><?php echo get_languageword('duration_needed_to_complete_book_in');?><sup>*</sup>:</label>
					<?php			   
					$val = '';
					if( isset($_POST['submitbutt']) )
					{
