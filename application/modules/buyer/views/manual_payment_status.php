	...
	echo form_open('',$attributes);?>
			<div class="row">
				...
				<button class="btn-link-dark dash-btn" name="submitbutt" type="Submit"><?php echo get_languageword('SAVE');?></button><!--&nbsp|&nbsp;<button class="btn-link-dark dash-btn" onclick="javascript:document.location = '<?php echo URL_BUYER_SUBSCRIPTIONS;?>'"><?php echo get_languageword('Cancel');?></button>-->
