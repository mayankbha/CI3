...
<?php 
//neatPrint($subjects);
if(count($seller_types) > 0) { ?>
<?php echo form_open('seller/manage-teaching-types', 'id="seller_subject_mngt" class="form-multi-select"');?>
	<div class="custom_accordion1">
		
		<div class="row">
		<?php
		$i = $counter  = 1;
		foreach($seller_types as $sub) 
		{
			if($i == 1)
			{
			?>
			...
			?>
				<div class="input-group ">
					<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $sub->id?>" name="seller_selected_types[]" <?php if(in_array($sub->id, $sellerSelectedTypeIds)) echo "checked";?>>
