...
// neatPrint($subjects);
if(count($subjects) > 0) { ?>
<?php echo form_open('seller/manage-subjects', 'id="seller_subject_mngt" class="form-multi-select"');?>
		...
		foreach($val as $sub) 
		{
			...
			?>
				<div class="input-group ">
					<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $sub->id?>" name="seller_subjects[]" <?php if(in_array($sub->id, $sellerSubjectIds)) echo "checked";?>>
