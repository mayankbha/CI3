      ...
      <div class="col-lg-12">
        <div class="dashboardMenu clearfix">
          <ul>
            ...
            <a href="<?php echo URL_AUTH_INDEX;?>/buyer">
              <div class="cir"><i class="flaticon-multimediaoption16"></i> </div>
              <h2><?php echo get_languageword('buyers')?> <br>
         </h2>
                </a>
            </li>
			
			<li <?php if(isset($activesubmenu) && in_array($activesubmenu, array('seller'))) echo 'class="active"';?>>
            <a href="<?php echo URL_AUTH_INDEX;?>/seller">
              <div class="cir"><i class="flaticon-multimediaoption16"></i> </div>
              <h2><?php echo get_languageword('sellers')?> <br>
         </h2>
                </a>
            </li>
