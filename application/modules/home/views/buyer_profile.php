    ...
    <div class="container">
        <div class="row-margin ">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="user-profile-pic">
                            <img src="<?php echo get_buyer_img($row->photo, $row->gender); ?>" alt="" class="img-responsive img-circle">
                        </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                        <div class="user-profile-content">
                            ...
                            <h4><strong><?php echo get_languageword('Buyer_Type'); ?>: </strong> 
                        ...
                        <div class="send-quote-block">
                            ...
                            <?php 
                                    ...
                                    if(!empty($row->lead_details)) {
                                        $book = $row->lead_details[0]->book_name;
                                    }
                                    $this->load->view('send_message', array('user_book_opts' => array(), 'to_user_type' => 'buyer', 'to_user_id' => $row->id, 'book' => $book)); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <ul class ="user-more-details">
                        <?php foreach ($row->lead_details as $lead) { ?>
                            ...
                            <li><div class="media-left"><?php echo get_languageword('book_seeking') ;?>:</div><div class="media-body"><?php echo $lead->book_name; ?></div></li>
                            ...
                            <li><div class="media-left"><?php echo get_languageword('buyer_present_status') ;?>:</div><div class="media-body"><?php echo $lead->present_status; ?></div></li>
            ...
            <!-- Gallery -->
            <?php if(!empty($row->buyer_gallery)) { ?>
            <div class="row mtop7">
                <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <div class="tab-content tabpill-content">
                        ...
                        <?php $i=1; foreach ($row->buyer_gallery as $gallery) { ?>
                ...
                <div class="col-sm-4">
                    <div class="NavPillTabs">
                        <ul class=" video-tabs video-thumbs">
                            <?php $i=1; foreach ($row->buyer_gallery as $gallery_thumbs) { ?>
