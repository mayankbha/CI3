        ...
        <div class="container">
            <div class="row offcanvas offcanvas-right row-margin">
                ...
                <?php if(!empty($categories)) {
                            ...
                            $this->load->view('sections/category_section_for_selling_books', array('categories' => $categories), false);
                      }
                ?>
                ...
                <div class="col-xs-12 col-sm-<?php if(empty($categories)) echo '12'; else echo '9'; ?> dashboard-content ">
                    ...
                    <div class="dashboard-panel">
                        ...
                        <hr> -->
                            <div id="book_list">
                                ...
                                <?php 
                                      if(!empty($selling_books)): 
                                        $this->load->view('sections/selling_book_section', array('selling_books' => $selling_books), false);
                                      else:
                                ?>
                            ...
                            <?php if($total_records > LIMIT_BOOK_LIST) { ?>
                            <!-- <div class="row" id="div_load_more">
                                <div class="col-sm-12 text-center">
                                    <div class="load-more" onclick="load_more();">
                                        <input type="hidden" name="limit" id="limit" value="<?php echo LIMIT_BOOK_LIST;?>" />
                                        <input type="hidden" name="offset" id="offset" value="<?php echo LIMIT_BOOK_LIST;?>" />
    ...
    {
        $.ajax({
            url:"<?php echo URL_HOME_LOAD_MORE_SELLING_BOOKS; ?>",
            data:{
              offset        : $('#offset').val(),
              limit         : $('#limit').val(),
            ...
            success :function(data){
                ...
                if(dta.result == "\n" || dta.result == "\r\n") {
                    ...
                    $(dta.result).hide().appendTo("#book_list").fadeIn(1000);
