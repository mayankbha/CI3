...
class Categories extends MY_Controller 
{
	...
	function index()
	{
		...
		$crud->columns('id','name','code', 'slug', 'is_popular', 'status');
		...
		$crud->field_type('is_parent', 'hidden', 1); //1-category, 0-book
	...
	function books()
	{
		...
		$crud->columns('id','name','code', 'slug', 'is_popular', 'status', 'created_by');
		...
		$crud->display_as('id', get_languageword('book_id'));
		...
		{
			if($crud_state == 'add')
			$this->data['activesubmenu'] = 'books-add';
